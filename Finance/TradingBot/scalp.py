# This code taken from https://github.com/hackingthemarkets/alpaca-websockets
# April 25, 2020 Sergey Kozachenko
# Alpaca API only allows US citizen to access WS realtime data
# Using Three White Candle Strategy to make orders
...
# requires live api key only US citizens
# curl "https://api.polygon.io/v2/aggs/ticker/AAPL/range/1/day/2019-01-01/2019-02-01?apiKey=TP0MuUwCK7NEfgLk3yqlrDPxzx4P9Aaplj3qL9Tn"